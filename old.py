...
class material_paint(Operator):
    ...
    @classmethod
    def poll(cls, context):
        print("MB poll image_paint: ",  bpy.ops.paint.image_paint.poll())
...
def register():    
    ...
    kmi = km.keymap_items.new("paint.material_paint", type='LEFTMOUSE', value='PRESS', shift=False, ctrl=False , alt=True)
    kmi.active = True
